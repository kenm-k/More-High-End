...
execute unless entity @e[tag=more_high_end_dimensional_armor_stand, distance=..0.5] run summon minecraft:armor_stand ~ ~ ~ {Tags:["more_high_end_dimensional_armor_stand"], CustomName:"\"dimensional armor stand\"", CustomNameVisible:1b, Invisible: true, Small: true, NoGravity: true, Marker: true}
...
execute if entity @e[tag=more_high_end_dimensional_armor_stand, distance=..0.1] run setblock ~ ~ ~ minecraft:oak_sign keep
