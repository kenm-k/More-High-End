# minecraft:overworld
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] if entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if data entity @s {Tags:["minecraft:overworld"]} at @s as @a[tag=!more_high_end_dimensional_moved, distance=..0.5] run tag @s add more_high_end_dimensional_mc_overworld
...
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] if entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if data entity @s {Tags:["minecraft:overworld"]} at @s as @a[tag=more_high_end_dimensional_mc_overworld, distance=..0.5] in minecraft:overworld run tp @s ~ ~ ~
...
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] if entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if data entity @s {Tags:["minecraft:the_nether"]} at @s as @a[tag=!more_high_end_dimensional_moved, distance=..0.5] run tag @s add more_high_end_dimensional_mc_the_nether
...
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] if entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if data entity @s {Tags:["minecraft:the_nether"]} at @s as @a[tag=more_high_end_dimensional_mc_the_nether, distance=..0.5] in minecraft:the_nether run tp @s ~ ~ ~
...
# minecraft:the_end
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] if entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if data entity @s {Tags:["minecraft:the_end"]} at @s as @a[tag=!more_high_end_dimensional_moved, distance=..0.5] run tag @s add more_high_end_dimensional_mc_the_end
...
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] if entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if data entity @s {Tags:["minecraft:the_end"]} at @s as @a[tag=more_high_end_dimensional_mc_the_end, distance=..0.5] in minecraft:the_end run tp @s ~ ~ ~
...
# more_high_end:test
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] if entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if data entity @s {Tags:["more_high_end:test"]} at @s as @a[tag=!more_high_end_dimensional_moved, distance=..0.5] run tag @s add more_high_end_dimensional_mhe_test
...
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] if entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if data entity @s {Tags:["more_high_end:test"]} at @s as @a[tag=more_high_end_dimensional_mhe_test, distance=..0.5] in more_high_end:test run tp @s ~ ~ ~
