...
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] at @s unless entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if entity @s[tag=!more_high_end_dimensional_unused] run particle minecraft:end_rod ^ ^0.5 ^0.5 0 0 0 0 1
execute as @e[type=minecraft:armor_stand, tag=more_high_end_dimensional_armor_stand] at @s unless entity @a[distance=..5, tag=more_high_end_dimensional_dimensioner] if entity @s[tag=more_high_end_dimensional_unused] run particle minecraft:soul_fire_flame ^ ^0.5 ^0.5 0 0 0 0 1
...
execute as @a[tag=more_high_end_dimensional_moved, tag=!more_high_end_dimensional_processing] at @s unless entity @e[tag=more_high_end_dimensional_armor_stand, distance=..1] run function more_high_end:dimensional_armor_stand/player_tag_clear
execute as @a[tag=more_high_end_dimensional_moved, tag=!more_high_end_dimensional_dimensioner] at @s unless entity @e[tag=more_high_end_dimensional_armor_stand, distance=..1] run function more_high_end:dimensional_armor_stand/player_tag_clear